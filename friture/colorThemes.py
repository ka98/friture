...
class __ColorThemes:
    ...
    disabledWindowText = QColor(127, 127, 127)
    base = QColor(42, 42, 42)
    alternativeBase = QColor(66, 66, 66)
    ...
    button = QColor(20, 20, 20)
    buttonText = QColor(255,255,255)
    disabledButtonText = QColor(127, 127, 127)
    brightText = QColor(255,0,0)
    link = QColor(42, 13, 218)
    highlight = QColor(42, 130, 218)
    disabledHighlight = QColor(80, 80, 80)
    highlightedText = QColor(255,255,255)
    disabledHighlighttedText = QColor(127, 127, 127)

    curve1 = QColor(255,255,255)
    curve2 = QColor(255, 80, 80)
    chartBackgroundUpperGradient1 = QColor(0,0,0)
    chartBackgroundLowerGradient1 = QColor(0,0,0)
    chartBackgroundUpperGradient2 = 0.
    chartBackgroundLowerGradient2 = 0.
    statisticsWindow = "black"
    ruler = QColor(255,255,255)
    octaveLabelText = QColor(255,255,255)
    gridStrong = QColor(50,50,50)
    gridWeak = QColor(35,35,35)
    octavePeakHistroy = [QColor(gb + 30, 0, 0) for gb in range(0, 255)]
    darken = True
